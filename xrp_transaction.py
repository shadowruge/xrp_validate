...
def validate_url(TRANSACTION_HASH):
  
  url = f'https://xrpscan.com/tx/{TRANSACTION_HASH}'
  try:
...
private_key = input("Enter your XRP private key: ")

# Validate the address and check the URL status
status_code = validate_url(private_key)
